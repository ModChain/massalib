...
var file_massa_api_v1_public_proto_rawDesc = []byte{
	...
	0x7d, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x61, 0x73, 0x73, 0x61, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x76, 0x31, 0x50, 0x01, 0x5a, 0x1d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x4d, 0x6f, 0x64, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x6d, 0x61, 0x73, 0x73, 0x61,
	0x67, 0x72, 0x70, 0x63, 0xa2, 0x02, 0x04, 0x4d, 0x41, 0x50, 0x49, 0xaa, 0x02, 0x10, 0x43, 0x6f,
	0x6d, 0x2e, 0x4d, 0x61, 0x73, 0x73, 0x61, 0x2e, 0x41, 0x70, 0x69, 0x2e, 0x76, 0x31, 0xba, 0x02,
	0x04, 0x4d, 0x41, 0x50, 0x49, 0xca, 0x02, 0x10, 0x43, 0x6f, 0x6d, 0x5c, 0x4d, 0x61, 0x73, 0x73,
	0x61, 0x5c, 0x41, 0x70, 0x69, 0x5c, 0x56, 0x31, 0xea, 0x02, 0x13, 0x43, 0x6f, 0x6d, 0x3a, 0x3a,
...
var file_massa_api_v1_public_proto_goTypes = []any{
	...
	(*ReadOnlyExecutionCall)(nil),                        // 118: massa.model.v1.ReadOnlyExecutionCall
	(*ReadOnlyExecutionOutput)(nil),                      // 119: massa.model.v1.ReadOnlyExecutionOutput
	(*BlockWrapper)(nil),                                 // 120: massa.model.v1.BlockWrapper
	(*AddressKeyEntry)(nil),                              // 121: massa.model.v1.AddressKeyEntry
	(*DatastoreEntry)(nil),                               // 122: massa.model.v1.DatastoreEntry
	(*EndorsementWrapper)(nil),                           // 123: massa.model.v1.EndorsementWrapper
	(*BlockParent)(nil),                                  // 124: massa.model.v1.BlockParent
	(*OperationWrapper)(nil),                             // 125: massa.model.v1.OperationWrapper
	(*SlotRange)(nil),                                    // 126: massa.model.v1.SlotRange
	(ScExecutionEventStatus)(0),                          // 127: massa.model.v1.ScExecutionEventStatus
	(*ScExecutionEvent)(nil),                             // 128: massa.model.v1.ScExecutionEvent
	(*PublicStatus)(nil),                                 // 129: massa.model.v1.PublicStatus
	(*Addresses)(nil),                                    // 130: massa.model.v1.Addresses
	(*SlotDraw)(nil),                                     // 131: massa.model.v1.SlotDraw
	(*StakerEntry)(nil),                                  // 132: massa.model.v1.StakerEntry
	(*DenunciationIndex)(nil),                            // 133: massa.model.v1.DenunciationIndex
	(*Slot)(nil),                                         // 134: massa.model.v1.Slot
	(*Error)(nil),                                        // 135: massa.model.v1.Error
	(*NativeAmount)(nil),                                 // 136: massa.model.v1.NativeAmount
	(*ArrayOfBytesWrapper)(nil),                          // 137: massa.model.v1.ArrayOfBytesWrapper
	(*BlockIds)(nil),                                     // 138: massa.model.v1.BlockIds
	(*SignedBlock)(nil),                                  // 139: massa.model.v1.SignedBlock
	(*EndorsementIds)(nil),                               // 140: massa.model.v1.EndorsementIds
	(*SignedEndorsement)(nil),                            // 141: massa.model.v1.SignedEndorsement
	(*FilledBlock)(nil),                                  // 142: massa.model.v1.FilledBlock
	(*OperationIds)(nil),                                 // 143: massa.model.v1.OperationIds
	(*OpTypes)(nil),                                      // 144: massa.model.v1.OpTypes
	(*SignedOperation)(nil),                              // 145: massa.model.v1.SignedOperation
	(ExecutionOutputStatus)(0),                           // 146: massa.model.v1.ExecutionOutputStatus
	(*Empty)(nil),                                        // 147: massa.model.v1.Empty
	(AsyncPoolChangeType)(0),                             // 148: massa.model.v1.AsyncPoolChangeType
	(*SlotExecutionOutput)(nil),                          // 149: massa.model.v1.SlotExecutionOutput
	(*wrapperspb.UInt64Value)(nil),                       // 150: google.protobuf.UInt64Value
	(*BlockInfo)(nil),                                    // 151: massa.model.v1.BlockInfo
	(*EndorsementInfo)(nil),                              // 152: massa.model.v1.EndorsementInfo
	(*OperationInfo)(nil),                                // 153: massa.model.v1.OperationInfo
}
...
func file_massa_api_v1_public_proto_init() {
	...
	file_massa_api_v1_public_proto_msgTypes[49].OneofWrappers = []any{
		(*ExecutionQueryResponse_Result)(nil),
		(*ExecutionQueryResponse_Error)(nil),
	}
	file_massa_api_v1_public_proto_msgTypes[50].OneofWrappers = []any{
	...
	file_massa_api_v1_public_proto_msgTypes[74].OneofWrappers = []any{
		(*PosChangesFilter_None)(nil),
		(*PosChangesFilter_Address)(nil),
	}
	file_massa_api_v1_public_proto_msgTypes[75].OneofWrappers = []any{
	...
	file_massa_api_v1_public_proto_msgTypes[77].OneofWrappers = []any{
	...
	file_massa_api_v1_public_proto_msgTypes[87].OneofWrappers = []any{
		(*SendEndorsementsResponse_EndorsementIds)(nil),
		(*SendEndorsementsResponse_Error)(nil),
	}
	file_massa_api_v1_public_proto_msgTypes[89].OneofWrappers = []any{
	...
	file_massa_api_v1_public_proto_msgTypes[99].OneofWrappers = []any{
	...
	file_massa_api_v1_public_proto_msgTypes[113].OneofWrappers = []any{
